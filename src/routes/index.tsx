      ...
      <section className="container mx-auto px-6 pt-12 md:pt-20 pb-20">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
          <div className="md:col-span-6 space-y-8">
            ...
            <h1 className="text-5xl lg:text-6xl xl:text-7xl font-extrabold leading-[1.05] tracking-tight">
              Řidičák s&nbsp;rodinným<br />
              <span className="text-primary">přístupem.</span><br />
              U Káči s&nbsp;jistotou.
            </h1>
            ...
            <div className="flex flex-wrap gap-4">
              <Link to="/kontakt" className="px-7 py-3.5 bg-primary text-primary-foreground font-bold rounded-md hover:bg-primary/90">
                Přihlásit se na kurz
              </Link>
              <Link to="/sluzby" className="px-7 py-3.5 border-2 border-foreground text-foreground font-bold rounded-md hover:bg-foreground hover:text-background transition-colors">
                Naše služby
              </Link>
            </div>
